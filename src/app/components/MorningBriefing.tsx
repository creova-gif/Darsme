...
interface BriefingData {
  ...
  overdueDebts: Array<{ name: string; amount: number; days: number }>;
...
export default function MorningBriefing({ data = DEFAULT_DATA, onDismiss, onSetTarget, theme = "dark" }: MorningBriefingProps) {
