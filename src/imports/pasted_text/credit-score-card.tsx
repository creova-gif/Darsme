...
const DEFAULT_DATA = {
  score: 68,
  maxScore: 100,
  tier: "Developing",           // Emerging | Developing | Established | Trusted
  monthsActive: 5,
  totalTransactions: 847,
  avgMonthlySales: 1240000,
  consistency: 72,              // % of days with at least 1 sale
  debtRepaymentRate: 61,        // % of credit extended that was repaid on time
  recordKeepingScore: 80,       // % of days with end-of-day close
  uniqueCustomers: 134,
  loanEligibility: {
    eligible: false,
    requiredScore: 75,
  ...
  factors: [
    { label: "Sales consistency", score: 72, max: 100, impact: "medium", tip: "Sell every day — even slow days matter. Days with zero sales hurt your score." },
    { label: "Debt repayment rate", score: 61, max: 100, impact: "high", tip: "Collect credit from customers faster. Your current 61% repayment rate is the biggest drag on your score." },
    { label: "Record keeping", score: 80, max: 100, impact: "low", tip: "Complete the end-of-day close every evening. You're already doing well here." },
    { label: "Transaction volume", score: 847, max: 1000, impact: "low", tip: "You're close to 1,000 lifetime transactions — a key lender milestone." },
    { label: "Customer base", score: 134, max: 200, impact: "medium", tip: "Growing to 200 unique customers strengthens your score." },
  ],
  lenders: [
...
export default function CreditScoreCard({ data = DEFAULT_DATA, theme = "dark" }) {
      ...
      <div className={`cs-root ${theme}`}>
        ...
        {!data.loanEligibility.eligible && (
          <div className="cs-unlock-card">
            ...
            <button className="cs-unlock-btn">See my action plan →</button>
          </div>
        )}
      </div>
    </>
